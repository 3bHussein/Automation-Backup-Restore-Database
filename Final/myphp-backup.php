 ...
 */
define("DB_USER", 'hithr_d685w');
define("DB_PASSWORD", 'Rn68Mi5%ub*&');
define("DB_NAME", 'hithr685');
define("DB_HOST", 'psmysql622106.dreamhostps.com');
define("BACKUP_DIR", ''); // Comment this line to use same script's directory ('.')
define("TABLES", 'torm_students,com_students,ads'); // Full backup
...
class Backup_Database {
    ...
    public function backupTables($tables = '*') {
        try {
            ...
            $sql = 'CREATE DATABASE IF NOT EXISTS `'.'u280714611_course'.'`'.";\n\n";
            
            // $sql = 'CREATE DATABASE IF NOT EXISTS `'.$this->dbName.'`'.";\n\n";
            // $sql .= 'USE `'.$this->dbName."`;\n\n";
            $sql .= 'USE `'.'u280714611_course'."`;\n\n";
